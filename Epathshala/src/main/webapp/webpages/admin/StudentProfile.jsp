...
<nav class="navbar navbar-expand-lg navbar navbar-light" style="background-color: #e3f2fd;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <a class="nav-link active" aria-current="page" href="/admin/${adminID}/showStudents" role="button"style="color: black;"><i class="cil-arrow-circle-left"></i></a>
...
<div class="mx-auto" style="width: 1100px;">
  <img src="${users.picture}" class="rounded float-left" style="padding-right: 50px; padding-left: 20px;" width="400" height="300" align="right">
    ...
    <p class="card-text">${students.s_class}</p>
  </div>
    <br>
    <form action="/admin/submit/${adminID}/${userID}/DeleteStudents" method="post">
        <button type="submit" name="action" value = "deleteStudents" class="btn btn-lg btn-success" >
