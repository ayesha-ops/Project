...
<div class="mx-auto" style="width: 1300px;">
    <nav class="navbar" style="background-color: white">
        <div class="container-fluid">
            <form class="d-flex" action="/admin/${adminID}/SearchStudent">
                <input class="form-control me-2" name="s" type="search" placeholder="Search for Students" aria-label="Search">
    ...
    <c:forEach var="course" items="${students}" varStatus="status">
        <div class="container" style="border-bottom: blue ;border-width: medium">
            <div class="row">
                <div class="col" style="background-color:white;color:black"><br><br><br>
                    <h3>
                    <a  aria-current="page" href="/admin/${adminID}/${course.get("ID")}/showStudentPage">
                        <h3><i class="fa fa-user" aria-hidden="true"></i> ${course.get("NAME")}
                            <br></h3>
                    </a>
                    Student Class : ${course.get('S_CLASS')}</h3>
