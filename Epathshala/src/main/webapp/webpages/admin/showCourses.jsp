...
<nav class="navbar navbar-expand-lg navbar navbar-light" style="background-color: #e3f2fd;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <a class="nav-link active" aria-current="page" href="/admin/${adminID}" role="button"style="color: black;"><i class="cil-arrow-circle-left"></i></a>
...
<div class="mx-auto" style="width: 1100px;">
    <nav class="navbar" style="background-color: white">
        <div class="container-fluid">
            <form class="d-flex" action="/admin/${adminID}/SearchCourse" method="post">
                <input class="form-control me-2" name="s" type="search" placeholder="Search for any course" aria-label="Search">
                <button class="btn btn-outline-success" type="submit" value="reset" >Search</button>
            </form>
        </div>
    </nav>
<div>
            ...
            <div class="container" style="border-bottom: blue ;border-width: medium">
                <div class="row">
                    <div class="col" style="background-color:white;color:black"><br><br><br>
                        <a  aria-current="page" href="/admin/${adminID}/${course.course_id}/showCoursePage">
                            <h3><i class="fa fa-book" aria-hidden="true"></i>  ${course.title}
                                <br>
                                </h3>
                        </a>
                        <h4>
                            <i class="fa fa-clock-o" aria-hidden="true"></i>
                                Creating Time : ${course.published_date}
                            <br>
                        </h4>
                        <span></span></div>
                    <hr>
