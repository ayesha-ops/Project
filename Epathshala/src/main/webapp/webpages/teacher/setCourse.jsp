...
<div class="mx-auto" style="width: 1400px;">
    ...
    <br><br>
    <form class="form-inline" action="/teacher/TeacherProfile/submit/${username}/${course_id}/SetCourse" method ="post">
        <div class="form-group mb-2">
            <strong>Set the title of The Course: </strong>
            <br>
            <input type="text" name= "sett" class="form-inline" placeholder="Matrix" value="${courses.title}">
        </div>
<%--        <div class="form-group mb-2">--%>

<%--            <strong>Duration: </strong>--%>
<%--            <br>--%>
<%--            <input type="text" name= "setd" class="form-inline" placeholder="Duration">--%>
<%--        </div>--%>
        <button type="submit" class="btn btn-primary mb-2" name="action" value="setCourse" >Save Changes</button>
    </form>
