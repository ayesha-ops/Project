...
<div class="mx-auto" style="width: 1100px;">
    ...
    <br><br>
    <form action="/teacher/TeacherProfile/submit/${username}/${courseID}/DeleteCourse" method="post">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                ...
                <c:forEach var="i" begin="1" end="${topics_list.size()}">
                    ...
                    <div class="card card-body">
                        <a href="/teacher/TeacherProfile/${username}/${course_info.course_id}/${topics_list.get(i-1).topic_id}/viewTopic"><i
                ...
                <h2 class="accordion-header" >
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                            aria-expanded="true" aria-controls="collapseOne">
                        <i class="fa fa-grav" aria-hidden="true"></i>Discussions
                    </button>
                </h2>
                <div class="card card-body">
                    <a href="/teacher/TeacherProfile/news-forum/view-specific-forum/${username}/${forum_id}"><i class="fa fa-book" aria-hidden="true"> Discussion Forum </i></a>
                </div>
            </div>
