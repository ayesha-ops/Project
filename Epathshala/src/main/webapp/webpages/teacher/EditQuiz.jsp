...
<nav class="navbar navbar-expand-lg navbar navbar-light" style="background-color: #e3f2fd;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <a class="nav-link active" aria-current="page" href="/teacher/TeacherProfile/${userID}/${course_ID}/${quiz_ID}/createQuiz" role="button"style="color: black;"><i class="cil-arrow-circle-left"></i></a>
...
<div class="mx-auto" style="width: 1100px;">
    <form action="/teacher/TeacherProfile/submit/${userID}/${course_ID}/${quiz_ID}/editQuiz" method ="post">
        <label for="0" class="form-label">WRITE THE QUESTION</label>
        <input type="text" value="${quiz.quiz_ques}" name="Ques" class="form-control" id="0" placeholder="Matrix">
        <br>
        <label for="1" class="form-label">Option1</label>
        <input type="text" value="${quiz.option1}" name="option1" class="form-control" id="1" placeholder="Matrix">
        <br>
        <label for="2" class="form-label">Option2</label>
        <input type="text" value="${quiz.option2}" name="option2" class="form-control" id="2" placeholder="Matrix">
        <br>
        <label for="3" class="form-label">Option3</label>
        <input type="text" value="${quiz.option3}" name="option3" class="form-control" id="3" placeholder="Matrix">
        <br>
        <label for="4" class="form-label">Option4</label>
        <input type="text" value="${quiz.option4}" name="option4" class="form-control" id="4" placeholder="Matrix">
        <br>
        <label for="5" class="form-label">ANS</label>
        <input type="text" value="${quiz.ques_ans}" name="ans" class="form-control" id="5" placeholder="Matrix">
        <br>
